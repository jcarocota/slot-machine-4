...
export class WinAnimation extends PIXI.Container {
    ...
    constructor(winAmount=0, posX=0, posY=0, reelsWindowX=0, reelsWindowWidth=0) {
        super();
    ...
    private draw = () => {
        ...
        this.winAmountTitle = new PIXI.Text(`$ ${this.winAmount.toFixed(2)} USD`, this.styleWinAmountTitle);
    ...
    private animateMoneyCount = (duration: number) => {
        ...
        const positionEnd = { x: this.posX, y: 0, rotation: 0, value: this.winAmount};
